...
$global:mathtools_version = "3_0_1_087" #Example: "3_0_1_055"
$global:mathtools_url = "http://movemen.com/files/downloads/mtv3/087" #do not add trailing slash, example: "http://movemen.com/files/downloads/mtv3/055"
...
If (Test-Path $idsregkey) {
    ...
    Switch ($idsMajorVersion) {
        ...
        17 { $idsYYYY = "2022"; "DEBUG: Adobe InDesign Server $idsYYYY"; downloadMathTools "$idsYYYY"; updateMathTools "$idsYYYY" }
    }
