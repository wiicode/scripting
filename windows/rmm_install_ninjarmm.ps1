...
$global:url = "https://url/s//ninja-corp.msi?dl=1"
$global:installdir = "ninja"
$global:installer = "ninja-corp.msi"
$global:installerlo = "ninja-corp.msi.txt"
...
#install
Start-Process msiexec.exe -ArgumentList '/i c:\ops\temp\work\ninja\ninja-corp.msi /q' -Verb runAs -Wait
